...
!
!  The normalization constant is chosen so that (1) has L^2(0,pi) norm 1 when dnu is
!  an integer.
!
...
subroutine jacobi_phase2(chebdata,dnu,da,db,nints,ab,avals,psivals)
use chebyshev
implicit double precision (a-h,o-z)
...
!
!  Construct the phase and amplitude functions for specified values
!  of the parameters.  This is a special version of the routine meant
!  for use by jacobi_quad ... use it at your own risk!
!
!  Input parameters:
!    chebdata - a chebexps_data structure containing the information needed to
!       manipulate function represented by k-point Chebyshev expansions
...
call jacobi_phase_solve2(chebdata%k,nints,ab,chebdata%xs,                       &
  chebdata%aintr,chebdata%aintr2,chebdata%aintr3,                              &
  chebdata%aintl,chebdata%aintl2,chebdata%aintl3,chebdata%u,                   &
  dnu,da,db,psivals,avals,a2)
...
subroutine jacobi_phase_solve2(k,nints,ab,xscheb,aintr,aintr2,aintr3, &
  aintl,aintl2,aintl3,u,dnu,da,db,psivals,avals,a2)
use chebyshev
implicit double precision (a-h,o-z)
...
!  on a collection of intervals. 
!
!  THIS IS A SPECIAL VERSION OF THE ROUTINE WHICH ONLY COMPUTES THE PHASE FUNCTION
